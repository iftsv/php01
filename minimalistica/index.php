<?php
	$php_gen_title = "<title>minimalistica</title>";
	$php_gen_h1 = "<h1>minimalistica</h1>";
	$php_gen_year = 2018;
...
<head>
	...
	<!-- style for generated menu-->
	<link rel="stylesheet" href="css/generated_menu.css" type="text/css" />
   <?php echo $php_gen_title;?>
</head>
<body>
	<div id="content">
        <?
        	...
        	$menu = [
        		"home" => [
        			["text" => "home_submenu_1", "link" => "home_submenu_1.html"],
        			["text" => "home_submenu_2", "link" => "home_submenu_2.html"],
        		],
        		"archive" => [
        			["text" => "archive_submenu_1", "link" => "archive_submenu_1.html"], 
        			["text" => "archive_submenu_2", "link" => "archive_submenu_2.html"], 
        			["text" => "archive_submenu_3", "link" => "archive_submenu_3.html"],
        		],
        		"contact" => [
        			["text" => "contact_submenu_1", "link" => "contact_submenu_1.html"],
        			["text" => "contact_submenu_2", "link" => "contact_submenu_2.html"],
        			["text" => "contact_submenu_3", "link" => "contact_submenu_3.html"],
        		],
        	];

        	function generateMenu($menu) {
        		$htmlObject = "<nav class=\"generated_menu\">";
        		$htmlObject .= "<ul id=\"menu\" class=\"topmenu\">";
        		foreach ($menu as $topmenu => $submenu) {
        			$htmlObject .= "<li>";
        			$htmlObject .= $topmenu;

        			$htmlObject .= "<ul class=\"submenu\">";
        			for($i = 0; $i < count($submenu); $i++) {
        				if(!empty($submenu[$i]["text"])) {
        					$htmlObject .= "<li>";
        					$htmlObject .= "<a href=\"" . $submenu[$i]["link"] . "\">" . $submenu[$i]["text"] . "</a>";
							$htmlObject .= "</li>";
        				}
        			}
        			$htmlObject .= "</ul>";
		...
		<div id="footer">
			<p>Copyright &copy; <?php echo $php_gen_year ?> <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>