                        ...
                        <td>
                            ...
                            ?>
                                <ul>
                                    ...
                                    <li id="li_4">
                                        <label class="description" for="element_4">Подробное описание товара </label><div><textarea id="element_4" name="item_desc_full" class="element textarea small" required autocomplete="on"><?=$item['item_desc_full'];?></textarea></div> 
                                    </li>
                                    <li id="li_3">
