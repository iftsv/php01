...
function BuildAuthMenu($sqlcon) {
	...
	if (isset($_SESSION["id_user"])) {
		if($_SESSION["user_role_name"] === "admin") {
			...
			if ($sqlcon === null) {die("500 - SQL connection is NULL!");}
			$auth_menu = "<li class='basket_info'>" . GetBasketInfo($sqlcon, $id_user) . "</li>";
...
/*
######## А ЭТО ПЕРЕМЕСТИТЬ В КОНТРОЛЛЕР НАДО
